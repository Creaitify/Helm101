...
SAMPLE_CAMPAIGNS: list[dict[str, object]] = [
    ...
    {
        "id": "pmax-tier1-wealth",
        "name": "Google PMax · Tier 1 Metros",
        "channel": "google",
        "daily_budget": 35_000,
        "spend_30d": 102_000,
        "results_30d": 242,
    ...
    {
        "id": "youtube-explainer-video",
        "name": "YouTube · 60s Fee-Only Review",
        "channel": "google",
        "daily_budget": 20_000,
        "spend_30d": 58_000,
        "results_30d": 115,
    ...
    {
        "id": "email-lead-reengagement",
        "name": "Email · Inactive Lead Nurture",
        "channel": "email",
        "daily_budget": 8_000,
        "spend_30d": 22_000,
        "results_30d": 74,

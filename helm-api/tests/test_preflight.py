...
def test_no_finding_ever_contains_a_configured_value(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    app_env = {
        "AUTH0_ISSUER": "https://leaky.eu.auth0.com/",
    ...
    # different code with different leak potential. An earlier version of this
    # test supplied every key non-empty, so the missing-key branch never ran and
    # a value interpolated there would not have been seen.
